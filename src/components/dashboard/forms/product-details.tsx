...
import MyMultiSelect from "../multi-select/my-multi-select";
  ...
  const handleSubmit = async (values: z.infer<typeof ProductFormSchema>) => {
    try {
      ...
      const response = await upsertProduct(
        {
          productId: data?.productId ? data.productId : uuidv4(),
            ...
            >
              ...
              <div className="flex flex-col gap-y-6 xl:flex-row">
                ...
                <FormField
                  ...
                  name="images"
                  render={({ field }) => (
                    <FormItem className="w-full xl:border-r xl:pr-4 xl:flex-[7]">
                      <FormControl>
                        <>
                          <ImagesPreviewGrid
                ...
                />
                {/* Colors */}
                <div className="w-full xl:pl-5 xl:flex-[3] flex flex-col gap-y-3">
                  <ClickToAddInputs
              ...
              {!isNewVariantPage && (
                <InputFieldset label="Category & Product Details">
              ...
              {!isNewVariantPage && (
                ...
                >
                  <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md p-4 shadow-sm transition-colors duration-300">
                    {/* Phần label checkbox */}
                    <label
                      htmlFor="freeShippingForAll"
                      className="ml-1 flex items-center gap-x-2 cursor-pointer select-none text-gray-700 dark:text-gray-200"
                    >
                      <FormField
                        control={form.control}
                    ...
                    {/* MultiSelect khi không chọn freeShippingForAllCountries */}
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                          {form
                            ...
                            .freeShippingCountriesIds?.map((country, index) => (
                              <div
                                key={country.id}
                                className="text-xs inline-flex items-center px-3 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-300 rounded-md gap-x-2 select-none"
                              >
