    ...
    <div>
      <div className="z-30 w-10 h-full absolute top-0 right-0 bg-gradient-to-t from-slate-500 to-slate-800 text-[13px] duration-100">
        <div className="fixed top-[35%] -translate-y-1/2 text-center">
          ...
          <SidelineItem
            link="/profile"
            image="/assets/images/sideline/couponn.png"
          >
            Coupons
          </SidelineItem>
          <SidelineItem
            link="/profile/wishlist"
            image="/assets/images/sideline/wishlist.png"
          >
            Wishlist
          </SidelineItem>
          <SidelineItem
            link="/profile/history"
            image="/assets/images/sideline/history.png"
          >
            History
          </SidelineItem>
        </div>
        ...
        <div className="fixed top-[60%] -translate-y-1/2 text-left">
          <SidelineItem
            link="/"
            image="/assets/images/sideline/share.png"
            className="-bottom-9"
          ...
          <SidelineItem
            link="/feedback"
            image="/assets/images/sideline/feedback.png"
          >
            Feedback
          </SidelineItem>
        </div>
